...
public class BanMenuGUI {
    ...
    public static void open(Player staff, Player target) {
        Inventory gui = Bukkit.createInventory(null, 54, "§cВыбор срока бана");
        ...
        gui.setItem(21, ban7Days);

        ItemStack ban14Days = new ItemStack(Material.ORANGE_STAINED_GLASS_PANE);
        ItemMeta meta14 = ban14Days.getItemMeta();
        meta14.setDisplayName("§6§l14 ДНЕЙ");
